...
class AstrologerChatAdapter(val context: AstrologerChatActivity, private val messageList: ArrayList<MessagesModel>, val isGroup:Boolean) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == 0) {
            val view = layoutInflater.inflate(R.layout.raw_chat_me_astrologer, parent, false)
            MyMessagesViewHolder(view)
        } else {
            val view = layoutInflater.inflate(R.layout.raw_chat_other_astrologer, parent, false)
    ...
    class MyMessagesViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(context: AstrologerChatActivity, chatModel: MessagesModel) {
