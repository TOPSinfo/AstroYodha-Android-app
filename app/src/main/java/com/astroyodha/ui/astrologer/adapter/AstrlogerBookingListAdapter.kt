...
class AstrlogerBookingListAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        val v =
            mInflater.inflate(R.layout.raw_booking_astrloger_list, parent, false)
        return ViewHolder(
            v
        )
    }
