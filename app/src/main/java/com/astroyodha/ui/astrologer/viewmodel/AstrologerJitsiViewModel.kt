...
import com.astroyodha.ui.astrologer.model.videocall.AstrologerCallList
...
@HiltViewModel
class AstrologerJitsiViewModel @Inject constructor(
                ...
                if (snapshot !== null) {
                    if(snapshot.isEmpty)
                    {
                        ...
                        for (dc in snapshot.documents) {
                            val callModel = AstrologerCallList.getCallList(dc)
