...
import com.astroyodha.ui.user.adapter.ChatAdapter
...
//                        intent.putExtra("isGroupCall", isGroup)
    ...
    private fun showAddRatingDialog() {
        ...
        btnSubmit.setOnClickListener {
            ...
            ratingModel.astrologerId = bookingModel.astrologerID
            ratingModel.rating = rating.toFloat()
            ratingModel.feedBack = edFeedBack.text.toString().trim()

            astrologerProfileViewModel.addRatingToAstrologer(ratingModel)
            mDialog.dismiss()
        }
    }
